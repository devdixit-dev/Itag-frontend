...
const FinancialCalculators = () => {
  ...
  useEffect(() => {
    calculateSIP();
  }, [sipAmount, sipRate, sipYears, inflPercent]);
                ...
                <Card className="card-finance">
                  ...
                  <CardContent className="space-y-6">
                    <div>
                      ...
                      <Input id="sipAmount" type="number" value={sipAmount} onChange={(e) => setSipAmount(Number(e.target.value))} className="mt-2" />
                    </div>
                    <div>
                      <Label htmlFor="sipRate">Expected Annual Return (%)</Label>
                      <Input id="sipRate" type="number" step="0.1" value={sipRate} onChange={(e) => setSipRate(Number(e.target.value))} className="mt-2" />
                    </div>
                    <div>
                      <Label htmlFor="sipYears">Investment Period (Years)</Label>
                      <Input id="sipYears" type="number" value={sipYears} onChange={(e) => setSipYears(Number(e.target.value))} className="mt-2" />
                    </div>
                    {/* <div>
                ...
                <Card className="card-finance">
                  ...
                  <CardContent className="space-y-6">
                    <div>
                      ...
                      <Input id="loanAmount" type="number" value={loanAmount} onChange={(e) => setLoanAmount(Number(e.target.value))} className="mt-2" />
                    </div>
                    <div>
                      <Label htmlFor="loanRate">Interest Rate (% per annum)</Label>
                      <Input id="loanRate" type="number" step="0.1" value={loanRate} onChange={(e) => setLoanRate(Number(e.target.value))} className="mt-2" />
                    </div>
                    <div>
                ...
                <Card className="card-finance">
                  ...
                  <CardContent className="space-y-6">
                    <div>
                      ...
                      <Input id="goalAmount" type="number" value={goalAmount} onChange={(e) => setGoalAmount(Number(e.target.value))} className="mt-2" />
                    </div>
                    <div>
                      <Label htmlFor="goalYears">Time Period (Years)</Label>
                      <Input id="goalYears" type="number" value={goalYears} onChange={(e) => setGoalYears(Number(e.target.value))} className="mt-2" />
                    </div>
                    <div>
